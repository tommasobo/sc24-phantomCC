...
def main():
    ...
    list_title_names = ["Random Traffic", "Incast Inter-DC Only", "Incast Mixed Inter-DC and Intra-DC"]
    list_custom_names = ["Random_Intra", "Random_All", "Incast_Tests3"]
    list_exp = ["output16.txt", "output32.txt"]
