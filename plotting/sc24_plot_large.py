...
def main():
    ...
    list_title_names = ["Incast Large Intra-DC Only", "Incast Large Inter-DC Only", "Incast Large Mixed Inter-DC and Intra-DC"]
    list_custom_names = ["Incast_Tests_large_1", "Incast_Tests_large_2", "Incast_Tests_large_3"]
    list_exp = ["incast_intra_dc_large", "incast_inter_dc_large", "incast_mix_large"]
