...
#ifndef COMPOSITE_QUEUE_NO_ECN_H
#define COMPOSITE_QUEUE_NO_ECN_H
...
class CompositeQueueNoEcn : public Queue {
  public:
    CompositeQueueNoEcn(linkspeed_bps bitrate, mem_b maxsize, EventList &eventlist, QueueLogger *logger);
    ...
    simtime_picosec last_good_transmit = 0;
