...
class Packet {
  ...
  public:
    ...
    //    void set_detour(PacketSink* n, int rewind) {_detour = n;_nexthop -=
    //    rewind;}
  ...
  protected:
    ...
    // used for tunneling purposes when one packet can be referenced by multiple
    // classes
    uint8_t _refcount;
...
template <class P> class PacketDB {
  public:
