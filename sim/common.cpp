...
bool LCP_OFF_RTT = false;
float LCP_ECN_FRACTION_THRESHOLD_LOW = 0.1;
float LCP_ECN_FRACTION_THRESHOLD_HIGH = 0.5;
...
uint32_t LCP_CONSECUTIVE_DECREASES_FOR_QA = 3;
