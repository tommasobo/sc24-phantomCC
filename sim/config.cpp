...
void initializeLoggingFolders() {
    ...
    std::filesystem::remove_all(PROJECT_ROOT_PATH / "output/acked/");
    ...
    std::filesystem::remove_all(PROJECT_ROOT_PATH / "output/ecn_fraction/");
    ...
    ret_val &= std::filesystem::create_directory(PROJECT_ROOT_PATH / "output/acked");
    ...
    ret_val &= std::filesystem::create_directory(PROJECT_ROOT_PATH / "output/ecn_fraction");
}
